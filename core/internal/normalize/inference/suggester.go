...
func (suggestion *ApplicableSuggestion) FormatAsMarkdown() string {
	...
	builder.WriteString(fmt.Sprintf("**Confianza:** %.2f\n\n", suggestion.Confidence))
	builder.WriteString(fmt.Sprintf("**Descripción:** %s\n\n", suggestion.Description))
	builder.WriteString(fmt.Sprintf("**Acción:** %s\n\n", suggestion.Action))
	builder.WriteString(fmt.Sprintf("**Sección objetivo:** %d\n\n", suggestion.TargetSection))
