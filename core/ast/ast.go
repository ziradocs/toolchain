...
//
// 2.1.0 (issue #21): nuevo MediaElement (discriminador "media") para
// audio/video embebido, con Autoplay/Controls/Loop/Muted — aditivo, un tipo
// de elemento nuevo no rompe ningún consumidor existente del contrato.
