...
requests, discussions, and any other project-run space), and also applies when an individual is
...
This project does not yet have a dedicated conduct-report mailbox. Instances of abusive,
harassing, or otherwise unacceptable behavior may be reported by contacting the project
maintainer, Misael Monterroca ([@mmonterroca](https://github.com/mmonterroca)), directly via
GitHub. All complaints will be reviewed and investigated promptly and fairly. As the project and
community grow, a dedicated reporting channel will be established and linked here.
